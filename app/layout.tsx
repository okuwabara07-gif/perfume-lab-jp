...
export const metadata: Metadata = {
  title: '香水Lab',
  description: '香水・フレグランス情報',
  openGraph: { title: '香水Lab', description: '香水・フレグランス情報', type: 'website', locale: 'ja_JP', siteName: '香水Lab' },
  twitter: { card: 'summary_large_image', title: '香水Lab', description: '香水・フレグランス情報' },
  ...
  return (
    <html lang="ja">
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html:`{"@context": "https://schema.org", "@type": "WebSite", "name": "香水Lab", "description": "香水・フレグランス情報", "url": "https://perfume-lab-jp.vercel.app", "publisher": {"@type": "Organization", "name": "AOKAE合同会社"}}`}} />
      </head>
      <body>{children}
